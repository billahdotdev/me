            ...
            <div className="flex flex-col md:flex-row md:items-start gap-6 p-6 rounded-xl border border-dashed border-border hover:border-accent hover:bg-surface transition-all duration-300">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Your business has a story, and I'm here to help you tell it online beautifully and effectively. If you
                  have an idea you're passionate about, I'll help bring it to life with stunning, user-friendly websites
